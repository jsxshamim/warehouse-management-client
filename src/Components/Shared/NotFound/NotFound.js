        ...
        <div className="container mx-auto pt-24">
            <div className="flex items-center flex-col justify-center lg:flex-row py-28 px-6 md:px-24 md:py-20 lg:py-32 gap-16 lg:gap-28">
                ...
                <div className="w-full lg:w-1/2">
                    ...
                    <button onClick={() => navigate("/")} className="w-full lg:w-auto my-4 border rounded-md px-1 sm:px-16 py-5 bg-secondary text-white hover:bg-secondary focus:outline-none focus:ring-2 focus:bg-secondary focus:ring-opacity-50">
                        Go back to Homepage
                    </button>
                </div>
            </div>
