                ...
                <div className="container mx-auto flex flex-wrap items-center justify-between">
                    ...
                    <div className={"lg:flex flex-grow items-center" + (navbarOpen ? " flex" : " hidden")} id="example-navbar-danger">
                        <ul className="flex flex-col gap-5 items-center lg:flex-row list-none lg:ml-auto">
                            ...
                            <li onClick={() => setShow(!show)} className="hidden nav-item cursor-pointer relative">
                                <div className="flex items-center gap-3">
                                    <img className="w-14 h-14 rounded-full border p-1" src="https://pixelwibes.com/template/ebazar/laravel/public/backend/dist/assets/images/profile_av.svg" alt="" />
                                </div>
                                {show && (
                                            ...
                                            <div className="w-[240px] p-5">
                                                <div className="card-body pb-0">
                                                    <div className="flex py-1 items-center gap-2">
                                                        <img className="rounded-full w-10 h-10" src="https://pixelwibes.com/template/ebazar/laravel/public/backend/dist/assets/images/profile_av.svg" alt="profile" />
                                                        <div className="flex-fill ms-3 ">
                                                            <h4 className="font-bold">John Quinn</h4>
