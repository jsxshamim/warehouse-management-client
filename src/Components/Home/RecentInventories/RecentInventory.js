        ...
        <div className="box-wrapper rounded-lg shadow-2xl relative">
            ...
            <div className="box-content ">
                ...
                <div className="border-b mb-2 pb-2">
                    <div className="pl-10 flex items-center justify-between  pr-5 ">
                        <p className="text-lg">
            ...
            <button onClick={() => navigate(`/inventory/${_id}`)} className="w-full bg-secondary text-white text-lg px-5 py-3 shadow">
                Stock Update
            </button>
